'''
Создан абстрактный класс Unit. От него наследуются Character и Monster. 
У каждого юнита есть шесть базовых характеристик: сила, ловкость, телосложение, 
мудрость, интеллект, харизма. Значения характеристик передаются в конструктор. 
Класс Unit содержит три абстрактных метода:
